...
//}
//
//_Thrd_result __cdecl _Cnd_init(_Cnd_t* const pcond) { // initialize
//    *pcond = nullptr;
//
...
//}
//
//_Thrd_result __cdecl _Cnd_wait(const _Cnd_t cond, const _Mtx_t mtx) { // wait until signaled
...
//}
//
//_Thrd_result __cdecl _Cnd_timedwait(const _Cnd_t cond, const _Mtx_t mtx, const xtime* const target) { // wait until signaled or timeout
//    auto res       = _Thrd_result::_Success;
//    const auto cs = static_cast<Concurrency::details::stl_critical_section_interface*>(_Mtx_getconcrtcs(mtx));
...
//}
//
//_Thrd_result __cdecl _Cnd_signal(const _Cnd_t cond) { // release one waiting thread
//    cond->_get_cv()->notify_one();
//    return _Thrd_result::_Success; // TRANSITION, ABI: Always returns _Thrd_result::_Success
//}
//
//_Thrd_result __cdecl _Cnd_broadcast(const _Cnd_t cond) { // release all waiting threads
