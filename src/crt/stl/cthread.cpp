...
//}
//
//_Thrd_result __cdecl _Thrd_join(_Thrd_t thr, int* code) { // returns when thread terminates
...
//    }
//
//    return NT_SUCCESS(ZwClose(thr._Hnd)) ? _Thrd_result::_Success : _Thrd_result::_Error;
//}
//
//_Thrd_result __cdecl _Thrd_detach(_Thrd_t thr) { // tell OS to release thread's resources when it terminates
//    return NT_SUCCESS(ZwClose(thr._Hnd)) ? _Thrd_result::_Success : _Thrd_result::_Error;
//}
//
